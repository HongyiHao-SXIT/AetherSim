...
struct internals {
  ...
  ~internals() {
    ...
    // finalize_interpreter(). That *SHOULD BE* fine. The following details what
    // happens whe PyThread_tss_free is called. PYBIND11_TLS_FREE is
    ...
    // PyMem_RawFree *requires* that the `tstate` be allocated with the CPython
    // allocator.
