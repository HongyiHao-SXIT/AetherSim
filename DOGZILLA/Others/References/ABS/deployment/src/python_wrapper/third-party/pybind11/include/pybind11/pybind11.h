...
#pragma GCC diagnostic pop
...

    {
      ...
      static_assert(
          has_arg_annotations || !has_pos_only_args,
          "py::pos_only requires the use of argument annotations (for "
          "docstrings and aligning the annotations to the argument)");
  ...
  static PyObject *dispatcher(PyObject *self, PyObject *args_in,
    ...
    try {
      ...
      for (; it != nullptr; it = it->next) {
        ...
        size_t args_to_copy =
            (std::min)(pos_args,
                       n_args_in); // Protect std::min with parentheses
...
public:
  ...
  module_ def_submodule(const char *name, const char *doc = nullptr) {
    ...
    auto result =
        reinterpret_borrow<module_>(PyImport_AddModule(full_name.c_str()));
  ...
  \endrst */
  static module_ create_extension_module(const char *name, const char *doc,
                                         module_def *def) {
#if PY_MAJOR_VERSION >= 3
    ...
    // TODO: Sould be reinterpret_steal for Python 3, but Python also steals it
    // again when returned from PyInit_...
  ...
  PYBIND11_NOINLINE void init(bool is_arithmetic, bool is_convertible) {
    ...
    m_base.attr("__repr__") = cpp_function(
        [](object arg) -> str {
          ...
          return pybind11::str("<{}.{}: {}>")
              .format(type_name, enum_name(arg), int_(arg));
        },
    ...
    if (is_convertible) {
      ...
      if (is_arithmetic) {
        ...
        m_base.attr("__invert__") =
            cpp_function([](object arg) { return ~(int_(arg)); },
...
#undef PYBIND11_ENUM_OP_STRICT
    ...
    m_base.attr("__getstate__") =
        cpp_function([](object arg) { return int_(arg); }, name("__getstate__"),
                     is_method(m_base));

    m_base.attr("__hash__") = cpp_function([](object arg) { return int_(arg); },
...
/** \rst
 ...
 to by the this_ptr.
  ...
  :this_ptr: The pointer to the object the overriden method should be retrieved
...
:c:macro:`PYBIND11_OVERRIDE_NAME`, except that it throws if no override can be
found.
\endrst */
