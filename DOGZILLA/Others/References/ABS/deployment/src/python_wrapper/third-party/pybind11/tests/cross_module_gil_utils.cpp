/*
    tests/cross_module_gil_utils.cpp -- tools for acquiring GIL from a different
   module
...
// this need not be the case. The typical scenario would be a DSO that
// implements shared logic used internally by multiple pybind11 modules.
