...
// constructors, below, we track and print out the actual class (e.g.
// ref<MyObject>), and *also* add a fake tracker for ref_tag.  This lets us
// check that the total number of ref<Anything> constructors/destructors is
