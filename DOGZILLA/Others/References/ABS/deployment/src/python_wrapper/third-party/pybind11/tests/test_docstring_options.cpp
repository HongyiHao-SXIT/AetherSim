...
TEST_SUBMODULE(docstring_options, m) {
  // test_docstring_options
  {
    ...
    m.def(
        "test_function2", [](int, int) {}, py::arg("a"), py::arg("b"),
        "A custom docstring");
    ...
    m.def(
        "test_overloaded2", [](double) {}, py::arg("d"),
    ...
    m.def(
        "test_function4", [](int, int) {}, py::arg("a"), py::arg("b"),
        "A custom docstring");

    options.disable_function_signatures().disable_user_defined_docstrings();

    m.def(
        "test_function5", [](int, int) {}, py::arg("a"), py::arg("b"),
        "A custom docstring");
  ...
  m.def(
      "test_function7", [](int, int) {}, py::arg("a"), py::arg("b"),
      "A custom docstring");
