...
TEST_SUBMODULE(sequences_and_iterators, m) {
  ...
  // test_map_iterator
  // Interface of a map-like object that isn't (directly) an unordered_map, but
  // provides some basic map-like functionality.
  class StringMap {
  public:
    StringMap() = default;
  ...
  // test_sequence_length: check that Python sequences can be converted to
  // py::sequence.
